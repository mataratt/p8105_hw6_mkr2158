...
* Model 1: My model with predictors: babysex, frace, gaweeks, malform, momage, mrace, ppbmi, and smoken
* Model 2: with predictors Length at Birth and Gestational Age
* Model 3: with predictors Head Circumference, Length, Sex, and All Interactions
* **Conclusion**: Model 1 (my proposed model) generated the highest RMSE, centered around 450, compared to the other two models. Model 2 performed substantially better than Model 1. However, Model 3, containing head circumference, length, sex, and interactions, provides the best prediction for birth weight and offers the best accuracy. 
